            ...
            this.calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventContent: function(arg) {
                    ...
                    const platformIcons = {
                        ...
                        tiktok: '<svg xmlns="http://www.w3.org/2000/svg" class="scheduler-platform-icon" style="color:#09090b" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.75a4.85 4.85 0 01-1.01-.06z"/></svg>',
                    };
                ...
                eventDrop: function(info) {
                    ...
                    fetch('/scheduler/api/reschedule/' + info.event.id + '/', {
                        ...
                        body: JSON.stringify({
                            scheduled_at: newStart.toISOString().slice(0, 19),
                        }),
                    })
